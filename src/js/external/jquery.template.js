...
(function($) {
    ...
    var templates = {},
        // Cache for previously rendered templates
    ...
    $.template = function(cache, str, obj, raw) {
        ...
        if (str in templates) {
            ...
            source = "var __=[];__.push('" + str[replace](/[\r\t\n]/g, " ")[split]("{%")[join]("\t")[replace](/((^|%\})[^\t]*)'/g, "$1\r")
            ...
            [replace](/\t=(.*?)%\}/g, "',$1,'")[split]("\t")[join]("');")[split]("%}")[join](";__.push('")[split]("\r")[join]("\\'") + "');return __.join('');";
            ...
            proxy = function(obj, raw) {
                ...
                var html = $.isArray(obj) ? $.map(obj, function(obj, idx) {
                    return render.call(obj, idx);
    ...
    $.fn.template = function (obj, raw) {
      var el = this[0], nn = el && el.nodeName;
      return $.template(nn && this[nn.toUpperCase() === 'TEXTAREA' ? 'val' : 'html']() || '', obj, raw);
    };
